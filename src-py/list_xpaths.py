...
# === Configuration ===
xsd_362_path = '../mismo-schemas/XML Schema Files v3.6.2_B373/MISMO_3.6.2_B373.xsd'  # Path to 3.6.2 XSD file
xsd_340_path = "../mismo-schemas/ReferenceModel_v3.4.0_B324_Combined/MISMO_3.4.0_B324.xsd" # Path to 3.4.0 XSD file
mismo_xsd_version = "362"  #Options: "362", "340"
xsd_path=""
...
def main():
    ...
    if mismo_xsd_version == "362":
        version_no="362"
        xsd_path = xsd_362_path
    elif mismo_xsd_version == "340":
        version_no="340"
        xsd_path = xsd_340_path
    ...
    output_file_type_suffix = "_recursive" if recursive_traversal else ""
    output_file = output_folder / f"xpaths_{target_type_name}{output_file_type_suffix}{version_no}.{output_file_type}"
